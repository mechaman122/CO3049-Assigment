...
if(isset($_POST['search']) && !empty($_POST['search'])){
    $url = "../admin/product-manager.php?search=" . $_POST['search'] . ".*";
    header("Location: $url");
}
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <?php } ?>
                        <li class="nav-item">
                            <a class="nav-link fw-bold" style="color:rgb(142, 216, 229)" href="user-manager.php?search=.*">Users Manager</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-bold active" aria-current="page" style="color: rgb(211, 230, 89);" href="product-manager.php?search=.*">Products Manager</a>
                        </li>
    ...
    <form name="frmUser" method="post" action="">
        <div>
            ...
            <?php
                ...
                if(preg_match($pattern, $row['item_name'])){
                ?>
                    <tr class="<?php if(isset($classname)) echo $classname;?>">
                    <td><input type="checkbox" name="items[]" value="<?php echo $row["item_id"]; ?>" ></td>
                    <td><?php echo $row["item_id"]; ?></td>
                    <td class="text-truncate" style="max-width: 150px;"><?php echo $row["item_name"]; ?></td>
                    <td><?php echo $row["item_price"]; ?></td>
                    <td><?php echo $row["item_cate"]; ?></td>
                    <td><?php echo $row["item_nsx"]; ?></td>
            ...
            ?>
            <tr class="listheader">
            <td colspan="4"><input class="btn btn-primary" type="button" name="add" value="Add" onClick="setAddAction();"/> <input class="btn btn-success" type="button" name="update" value="Update" onClick="setUpdateAction();"/> <input class="btn btn-danger" type="button" name="delete" value="Delete"  onClick="setDeleteAction();"/></td>
            </tr>
            </table>
        </div>
    </form>
