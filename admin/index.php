...
<body>
    ...
    <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link fw-bold" href="../homepage/index.php">Home</a>
                        </li>
                        <?php if($username == "admin1") { ?>
                            <li class="nav-item">
                                <a class="nav-link fw-bold active" aria-current="page" href="#">AdminDashBoard</a>
                            </li>
                        <?php } ?>
                        <li class="nav-item">
                            <a class="nav-link fw-bold" href="user-manager.php?search=.*">Users Manager</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-bold" href="product-manager.php?search=.*">Products Manager</a>
                        </li>
        ...
        <h1>Here, you can add/delete user accounts and products as you like</h1>
        <img src="../img/among-us-background.jpg" style="width:100vw; height:auto" alt="">
    </div>
